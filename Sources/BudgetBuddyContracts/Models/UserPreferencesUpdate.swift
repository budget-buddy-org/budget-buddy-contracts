...
public struct UserPreferencesUpdate: Sendable, Codable, Hashable {
    ...
    /** New preferred currency as an ISO 4217 three-letter code. */
    public var currency: String?
    /** New preferred IANA timezone. */
    public var timezone: String?

    public init(language: String? = nil, currency: String? = nil, timezone: String? = nil) {
